...
OPTIMIZATION = s
TARGET       = main
SRC          = $(TARGET).c Descriptors.c Board/Hardware.c Board/commands.c Board/at45db321d.c Board/lsm303.c Board/datalogger.c Board/status.c version.c $(COMMON_PATH)/command.c $(COMMON_PATH)/twi.c $(COMMON_PATH)/dfu_jump.c $(COMMON_PATH)/mem_usage.c $(LUFA_SRC_USB) $(LUFA_SRC_USBCLASS)
